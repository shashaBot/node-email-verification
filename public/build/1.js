...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__qrcode__ = __webpack_require__(291);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ionic_native_core__ = __webpack_require__(101);
...
var QrcodePage = (function () {
    function QrcodePage(navCtrl, navParams, plt, sesSer, loadingCtrl, alertCtrl, ren) {
    ...
    QrcodePage.prototype.ionViewWillEnter = function () {
        ...
        if (this.plt.is('core')) {
            this.showLoading();
            this.sesSer.createQrCodes().subscribe(function (data) {
                if (data.success) {
                    _this.loading.dismiss();
                    _this.qrCodes = data.data;
                    console.log(_this.qrCodes);
                }
                else {
                    _this.showError('Error in displaying QR codes!');
                }
            });
            this.checkInterval = setInterval(function () {
                _this.sesSer.checkQr().subscribe(function (res) {
                    if (res.success)
                        _this.onSessionScanned({ session: res.session, token: res.token });
                });
            }, 3000);
        }
    };
    QrcodePage.prototype.ionViewWillLeave = function () {
        if (this.plt.is('core')) {
            this.sesSer.removeAllTokens().subscribe(function (res) { return console.log(res); });
            if (this.checkInterval) {
                clearInterval(this.checkInterval);
            }
        }
    };
    QrcodePage.prototype.onQrScanned = function (data) {
        var _this = this;
        // this.ren.setStyle(this.content.nativeElement, 'background-color', '#fff');
        this.scanned = true;
        console.log('onQrScanned', data);
        this.sesSer.scannedQr(data).subscribe(function (res) {
            if (res.success) {
                // display session information
                _this.scannedSession = res.session;
                console.log(_this.scannedSession);
            }
            else if (res.msg) {
                _this.showError(res.msg);
            }
            else {
                _this.showError('The QR code could not be verified! Try again.');
            }
        });
    };
    QrcodePage.prototype.onSessionScanned = function (data) {
    ...
    QrcodePage.prototype.showError = function (text) {
...
QrcodePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-qrcode',template:/*ion-inline-start:"/media/shashwat/Data/coding/codebase/MEAN/Ionic-Node-auth/ionic-src/src/pages/qrcode/qrcode.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title *ngIf="plt.is(\'core\')">Qr Codes</ion-title>\n    <ion-title *ngIf="plt.is(\'mobile\')">Scan QR Code</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding #content>\n  <session-codes *ngIf="plt.is(\'core\')" [qrCodes]="qrCodes"></session-codes>\n  <scan-session-qr *ngIf="plt.is(\'cordova\')" [scannedSession]="scannedSession" (qrScanned)="onQrScanned($event)"></scan-session-qr>\n</ion-content>\n'/*ion-inline-end:"/media/shashwat/Data/coding/codebase/MEAN/Ionic-Node-auth/ionic-src/src/pages/qrcode/qrcode.html"*/,
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__session_codes_session_codes__ = __webpack_require__(293);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__scan_session_qr_scan_session_qr__ = __webpack_require__(294);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angular2_qrcode__ = __webpack_require__(295);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_qr_scanner__ = __webpack_require__(285);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
ComponentsModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        declarations: [__WEBPACK_IMPORTED_MODULE_2__session_codes_session_codes__["a" /* SessionCodesComponent */],
            __WEBPACK_IMPORTED_MODULE_3__scan_session_qr_scan_session_qr__["a" /* ScanSessionQrComponent */]],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicModule */],
            __WEBPACK_IMPORTED_MODULE_4_angular2_qrcode__["a" /* QRCodeModule */]
        ],
        exports: [__WEBPACK_IMPORTED_MODULE_2__session_codes_session_codes__["a" /* SessionCodesComponent */],
            __WEBPACK_IMPORTED_MODULE_3__scan_session_qr_scan_session_qr__["a" /* ScanSessionQrComponent */],
        ],
        providers: [__WEBPACK_IMPORTED_MODULE_5__ionic_native_qr_scanner__["a" /* QRScanner */]]
    })
], ComponentsModule);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SessionCodesComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_session_session__ = __webpack_require__(197);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var SessionCodesComponent = (function () {
    function SessionCodesComponent(loadingCtrl, alertCtrl, sesSer) {
        this.loadingCtrl = loadingCtrl;
        this.alertCtrl = alertCtrl;
        this.sesSer = sesSer;
    ...
    SessionCodesComponent.prototype.ngOnInit = function () {
    };
    SessionCodesComponent.prototype.ngAfterViewInit = function () {
    };
    SessionCodesComponent.prototype.showLoading = function () {
        this.loading = this.loadingCtrl.create({
            content: 'Please wait...',
            dismissOnPageChange: true
        });
    ...
    SessionCodesComponent.prototype.showError = function (text) {
        this.loading.dismiss();
        var alert = this.alertCtrl.create({
            title: 'Fail',
            subTitle: text,
    ...
    return SessionCodesComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Array)
], SessionCodesComponent.prototype, "qrCodes", void 0);
SessionCodesComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'session-codes',template:/*ion-inline-start:"/media/shashwat/Data/coding/codebase/MEAN/Ionic-Node-auth/ionic-src/src/components/session-codes/session-codes.html"*/'<ion-row>\n  <ion-col *ngFor="let code of qrCodes" col-md-6 col-sm-12 class="qr-code-col">\n    <qr-code [value]="code" [size]="180"></qr-code>\n  </ion-col>\n</ion-row>\n'/*ion-inline-end:"/media/shashwat/Data/coding/codebase/MEAN/Ionic-Node-auth/ionic-src/src/components/session-codes/session-codes.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* LoadingController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
        __WEBPACK_IMPORTED_MODULE_2__providers_session_session__["a" /* SessionProvider */]])
], SessionCodesComponent);

//# sourceMappingURL=session-codes.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ScanSessionQrComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_native_qr_scanner__ = __webpack_require__(285);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ScanSessionQrComponent = (function () {
    function ScanSessionQrComponent(qrScanner) {
        this.qrScanner = qrScanner;
        this.qrScanned = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.isScanning = false;
        this.scanned = false;
        console.log('Hello ScanSessionQrComponent Component');
    }
    ScanSessionQrComponent.prototype.ngOnInit = function () {
        this.scannerSub = this.qrScanner.prepare();
    };
    ScanSessionQrComponent.prototype.startScanner = function () {
        var _this = this;
        this.scannerSub
            ...
            if (status.authorized && !status.scanning) {
                ...
                _this.scanned = true;
                _this.scanSub = _this.qrScanner.scan().subscribe(function (data) {
                    console.log('something scanned!', data);
                    _this.qrScanned.emit(data);
                    _this.qrScanner.hide().then(function (status) {
                ...
                _this.qrScanner.show().then(function (status) {
                    console.log('qrScanner status', status);
    ...
    return ScanSessionQrComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
    __metadata("design:type", Object)
], ScanSessionQrComponent.prototype, "scannedSession", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"])
], ScanSessionQrComponent.prototype, "qrScanned", void 0);
ScanSessionQrComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'scan-session-qr',template:/*ion-inline-start:"/media/shashwat/Data/coding/codebase/MEAN/Ionic-Node-auth/ionic-src/src/components/scan-session-qr/scan-session-qr.html"*/'<ion-row *ngIf="scanned && !isScanning">\n  <ion-col>\n    Session name:\n  </ion-col>\n  <ion-col>\n    {{scannedSession.name}}\n  </ion-col>\n  <ion-col col-12>\n    <button ion-button full (click)="startScanner()">Scan Again</button>\n  </ion-col>\n</ion-row>\n<ion-row *ngIf="!scanned && !isScanning">\n  <ion-col>\n    <button ion-button full (click)="startScanner()">Start Scanner</button>\n  </ion-col>\n</ion-row>\n'/*ion-inline-end:"/media/shashwat/Data/coding/codebase/MEAN/Ionic-Node-auth/ionic-src/src/components/scan-session-qr/scan-session-qr.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__ionic_native_qr_scanner__["a" /* QRScanner */]])
], ScanSessionQrComponent);

//# sourceMappingURL=scan-session-qr.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_qrious__ = __webpack_require__(296);
